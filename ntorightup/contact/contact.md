...
и так как сервер не хочет принимать +document.cookie в fetch в message, нужно попробовать отправить в message ссылку на тот же сайт но с параметром lang, который отправляет запрос на мой сервер, то есть если проще, запрос в message такого вида:
